...
public class SearchRooms extends AppCompatActivity {
    String Search, Browse, Space, Cap, Rat, searchQuery, ip, db, un, pass, Pr, updateQuery;
    ...
    public void onButtonClickSearchRating(View v){
        ...
        Rat = "Rating: ";
        Pr = "| Price: ";
        searchQuery = "SELECT * FROM DB_A2EB9D_471Hotels.dbo.Rooms WHERE Rating = '"+ratingString+"' AND Availability = 'Yes'";
